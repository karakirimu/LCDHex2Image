import { Button, Card, Col, Container, FormElement, Grid, Input, Link, Radio, Row, Spacer, Text, Textarea } from "@nextui-org/react";
...
function App() {
  ...
  const [lcdWidth, setLcdWidth] = useState(16)
  const [lcdHeight, setLcdHeight] = useState(16)
